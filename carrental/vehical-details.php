...
$sql="INSERT INTO  tblbooking(BookingNumber,userEmail,VehicleId,FromDate,ToDate,Hours,PickAddress, DropAddress, Labour,message,Status) VALUES(:bookingno,:useremail,:vhid,:fromdate,:todate,:hours,:pickaddress, :dropaddress, :labour,:message,:status)";
...
$query->bindParam(':pickaddress',$pickaddress,PDO::PARAM_STR);
$query->bindParam(':dropaddress',$dropaddress,PDO::PARAM_STR);
$query->bindParam(':labour',$labour,PDO::PARAM_STR);
...
<title>Vehicle Hiring | Vehicle Details</title>
<!--Bootstrap -->
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <textarea rows="4" class="form-control" name="pickaddress" placeholder="Pick Address" required></textarea>
            </div>
            <div class="form-group">
              <textarea rows="4" class="form-control" name="dropaddress" placeholder="Drop Address" required></textarea>
            </div>
            <div class="form-group">
              <label>Labour:</label>
              <input type="number" class="form-control" name="labour" placeholder="BDT 200/person" required>
            </div>
            <div class="form-group">
